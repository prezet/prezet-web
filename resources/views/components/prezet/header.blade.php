    ...
    <div class="relative">
        <div class="flex h-16 min-w-0 items-center md:mx-3">
            ...
            >
                ...
                <div
                    class="relative ml-auto flex flex-1 items-center justify-end space-x-4"
                >
                    <nav class="text-sm">
                        <ul class="flex items-center space-x-6">
                            <li class="navbar-link hidden lg:block">
                                <a
                                    href="https://github.com/prezet/prezet/discussions"
                                    class="flex items-center gap-1.5 font-medium whitespace-nowrap text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
                                    target="_blank"
                                >
                                    Discussions
                                </a>
                            ...
                            <li class="flex whitespace-nowrap">
                                <a
                                    target="_blank"
                                    class="group relative inline-flex items-center px-4 py-1.5 text-sm font-semibold"
